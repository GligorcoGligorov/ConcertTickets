...
namespace EShop.Repository.Migrations
{
    ...
    [Migration("20230824135815_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.Concert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ConcertInOrder", b =>
                {
                    ...
                    b.HasKey("ConcertId", "OrderId");

                    b.HasIndex("OrderId");

                    b.ToTable("ConcertInOrders");
                });

            modelBuilder.Entity("EShop.Domain.DomainModels.ConcertInShoppingCart", b =>
                {
                    b.Property<Guid>("ConcertId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ConcertId", "ShoppingCartId");

                    b.HasIndex("ShoppingCartId");

                    b.ToTable("ConcertInShoppingCarts");
                });
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ConcertInOrder", b =>
                {
                    b.HasOne("EShop.Domain.DomainModels.Order", "UserOrder")
                        .WithMany("ConcertInOrders")
                        .HasForeignKey("ConcertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EShop.Domain.DomainModels.Concert", "OrderedConcert")
                        .WithMany("ConcertInOrders")
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ConcertInShoppingCart", b =>
                {
                    b.HasOne("EShop.Domain.DomainModels.ShoppingCart", "ShoppingCart")
                        .WithMany("ConcertInShoppingCarts")
                        .HasForeignKey("ConcertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EShop.Domain.DomainModels.Concert", "Concert")
                        .WithMany("ConcertInShoppingCarts")
